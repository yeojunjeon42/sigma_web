...
export default function Footer() {
  return (
    <footer className="relative z-10 bg-dark pt-16 md:pt-20 lg:pt-24 text-white">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              ...
              <div className="flex items-center gap-4">
                {/* Social Placeholders */}
                <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white hover:bg-bright-red transition-colors">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-12 lg:mb-16">
              ...
              <p className="mb-4 text-base text-gray">contact@sigma.snu.ac.kr</p>
            </div>
          </div>
        </div>
      </div>
